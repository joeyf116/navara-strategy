      ...
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Upload documents, then share through your SFTP workflow in AWS Transfer Family.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <p className="text-sm text-neutral-600">
              Shared files: <span className="font-medium text-neutral-900">{totalShared}</span>
            </p>
                ...
                {files.length === 0 ? (
                  ...
                  files.map((file) => (
                    <TableRow key={file.id}>
                      ...
                      <TableCell>{Math.max(1, Math.round(file.size_bytes / 1024))} KB</TableCell>
